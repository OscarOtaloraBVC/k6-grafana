...
const HARBOR_URL = 'test-nuam-artifactory.coffeesoft.org';
const PROJECT_NAME = 'k6-prueba';
const IMAGE_NAME = 'ubuntu';
const image_tag_prefix = 'latest';
const PROMETHEUS_URL = 'http://localhost:9090'; 

const HARBOR_USER = 'admin';
const HARBOR_PASSWORD = 'Nuam123.*';
...
const summaryText = `Duración de la prueba: ${duration} minutos`;
